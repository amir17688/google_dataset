...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RconCommand'
        db.create_table('mod_rconcommand', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(related_name='config_rconcommands', to=orm['mod.Server'])),
        ...
        db.send_create_signal('mod', ['RconCommand'])

        # Adding model 'AvailableRconCommand'
        db.create_table('mod_availablerconcommand', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(related_name='config_available_rconcommands', to=orm['mod.Server'])),
            ('command', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('mod', ['AvailableRconCommand'])


    def backwards(self, orm):
        # Deleting model 'RconCommand'
        db.delete_table('mod_rconcommand')

        # Deleting model 'AvailableRconCommand'
        db.delete_table('mod_availablerconcommand')
