...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field allowed_mods on 'UserProfile'
        db.create_table('accounts_userprofile_allowed_mods', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['accounts.userprofile'], null=False)),
            ('mod', models.ForeignKey(orm['mod.mod'], null=False))
        ))
        db.create_unique('accounts_userprofile_allowed_mods', ['userprofile_id', 'mod_id'])


    def backwards(self, orm):
        # Removing M2M table for field allowed_mods on 'UserProfile'
        db.delete_table('accounts_userprofile_allowed_mods')
