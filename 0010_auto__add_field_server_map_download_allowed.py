...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.map_download_allowed'
        db.add_column('mod_server', 'map_download_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Server.map_download_allowed'
        db.delete_column('mod_server', 'map_download_allowed')
