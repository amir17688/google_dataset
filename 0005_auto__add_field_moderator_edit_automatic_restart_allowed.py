...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Moderator.edit_automatic_restart_allowed'
        db.add_column('accounts_moderator', 'edit_automatic_restart_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Moderator.edit_automatic_restart_allowed'
        db.delete_column('accounts_moderator', 'edit_automatic_restart_allowed')
