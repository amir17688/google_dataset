...
import ilorest.rest.v1_helper

from ilorest.ris.sharedtypes import Dictable
...
class RisMonolithMember_v1_0_0(RisMonolithMemberBase):
    ...
    def load_from_dict(self, src):
        ...
        if u'Type' in src:
            ...
            src['restreq'] = restreq
            self._resp = ilorest.rest.v1_helper.StaticRestResponse(**src)
...
class RisMonolith_v1_0_0(Dictable):
    ...
    def _load(self, path, skipcrawl=False, originaluri=None, includelogs=False,\
        ...
        """Helper function to main load funtion.
    ...
    def branch_worker(self, resp, path, skipinit):
        ...
        :param resp: response received from iLO.
        :type resp: str.
        ...
        member = RisMonolithMember_v1_0_0(resp, self.is_redfish)
        if not member.type:
            return
    ...
    def load_from_dict(self, src):
        ...
        for typ in src[u'Types']:
            for inst in typ[u'Instances']:
                member = RisMonolithMember_v1_0_0(None, self.is_redfish)
